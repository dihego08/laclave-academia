<?php
class html_horarios extends f{
    private $baseurl = "";

    function html_horarios(){
            ...
            <script>
                ...
                $(document).ready(function() {
                    ...
                    var table = $(".datatable").DataTable({
                        "ajax": {
                            url: "' . $this->baseurl . INDEX . 'horarios/loadhorarios/",
                            "dataSrc": ""
                        },
                        "columns": [{
                            "data": "ciclo"
                ...
                function eliminar(id) {
                    $.ajax({
                        url: "' . $this->baseurl . INDEX . 'horarios/eliminar",
                        type: "POST",
                        dataType: "html",
                        data: {
                            "id": id,
                ...
                function editar(id){
                    $.ajax({
                        url: "' . $this->baseurl . INDEX . 'horarios/editar",
                        type: "POST",
                        dataType: "json",
                        data: {
                            "id": id,
                        ...
                        success: function(data) {
                            ...
                            $("#hora_inicio").val(data.inicio);
                            $("#hora_fin").val(data.fin);
                            $("#dia").val(data.dia);
                ...
                function guardar_horario(){
                    $.post("'.$this->baseurl . INDEX . 'horarios/save", {
                        id_curso: $("#id_curso").val(),
                        fecha: $("#fecha").val(),
                        inicio: $("#hora_inicio").val(),
                        fin: $("#hora_fin").val(),
                        dia: $("#dia").val(),
                    }, function(response){
                        var obj = JSON.parse(response);
                ...
                function actualizar_horario(id){
                    $.post("'.$this->baseurl . INDEX . 'horarios/editarBD", {
                        id_curso: $("#id_curso").val(),
                        fecha: $("#fecha").val(),
                        inicio: $("#hora_inicio").val(),
                        fin: $("#hora_fin").val(),
