...
class html_asistencias_2 extends f{
    private $baseurl = "";

    function html_asistencias_2(){
        ...
        $r = '<script>
            ...
            <script>
                ...
                function realizar_busqueda(){
                    dateRange($("#fecha_desde").val(), $("#fecha_hasta").val())
                    ...
                    $.get("' . $this->baseurl . INDEX . 'asistencias_2/loadasistencias/",{
