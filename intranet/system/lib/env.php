<?php 
	try{
		$mbd = new PDO('mysql:host=softluttioncom.ipagemysql.com; dbname=db_laclave;', 'laclave_se', 'laclave_se', array(PDO::MYSQL_ATTR_INIT_COMMAND => 'SET NAMES  \'UTF8\', SESSION SQL_BIG_SELECTS=1'/*, PDO::MYSQL_ATTR_INIT_COMMAND => 'SET SESSION SQL_BIG_SELECTS=1'*//*,  PDO::MYSQL_ATTR_INIT_COMMAND => "max_join_size=#"*/));
