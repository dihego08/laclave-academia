<?php
class html_asistencia_diaria extends f
{
    private $baseurl = "";

    function html_asistencia_diaria()
    {
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 col-md-12">
                        <h5 class="">
                            <i class="fa fa-bars" aria-hidden="true"></i> Lista de Alumnos Inasistentes
                        </h5>
                        <small>
                            <i class="fa fa-edit"></i> Aquí podrá ver toda la información de todos los Alumnos Inasistentes
                        </small>
                        <hr>         
            ...
            <script>
                $(document).ready(function() {
                    ...
                    var table = $(".datatable").DataTable({
                        "ajax": {
                            url: "' . $this->baseurl . INDEX . 'asistencia_diaria/load_asistencia_diaria/",
                            "dataSrc": "",
                            "data": function (data) {
                                var _date = $("#fecha").val();
                        ...
                        "columns": [{
                            ...
                            "render": function(data){
                                return `<span class="badge badge-danger">FALTA</span>`;
                            },
                        }, ],
                        "language": {
