...
class gastos extends f
{
    ...
    function gastos()
    {
        ...
        $this->html        = $this->load()->lib("html_gastos");
    ...
    public function loadgastos_2()
    {
        if ($this->valida(5)) {
            $sql = "SELECT * from t_gastos where fecha between '" . $_GET['fecha_desde'] . "' AND '" . $_GET['fecha_hasta'] . "'";
        } elseif ($this->valida(3)) {
            $sql = "SELECT * from t_gastos where fecha between '" . $_GET['fecha_desde'] . "' AND '" . $_GET['fecha_hasta'] . "'";
        }
        $gastos = $this->modelo2->select('', '', '', $sql);
