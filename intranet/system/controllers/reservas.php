<?php
    class reservas extends f{
        ...
        function reservas() {
            ...
            $this->html        = $this->load()->lib("html_reservas");
        ...
        function index() {
            if ($this->valida(5)) {
                $h["title"]   = "Reserva de Asientos";
                $c["content"] = $this->html->container();
                $c["title"]   = "Reserva de Asientos";
                $this->View($h, $c);
        ...
        function guardar_tipo_asiento(){
            $sql = "UPDATE asientos SET id_tipo = ". $_POST['id_tipo'] ." WHERE placa_bus = '". $_POST['placa_bus'] ."' AND piso = ". $_POST['piso']." AND n_asiento = ".$_POST['n_asiento'];
        ...
        function save(){
            ...
            echo $this->modelo2->insert_data("reservas", $_POST, false);
        }
        function eliminar(){
